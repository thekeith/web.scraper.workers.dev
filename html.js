...
<html lang="en" with-selection-styled>
  <head>
    ...
    <meta property="og:url" content="https://web.zorz.workers.dev">
    ...
    <meta name="twitter:url" content="https://web.zorz.workers.dev">
  ...
  <body>
    <div class="Surface">
      <div class="Panel">
        <div class="Panel--top">
          <h1><a href="https://web.zorz.workers.dev" class="Link Link-without-underline"><span class="WebScraperLogo"><span>web.zorz</span><span class="WebScraperLogo--muted">.workers.dev</span></span></a></h1>
        ...
        <main class="Panel--main" is-smooth-scrolling>
          <form id="form" class="Stack" method="GET" action="https://web.zorz.workers.dev">
            <div class="FormField">
        ...
        <div class="Panel--bottom">
          <div class="Row">
            ...
            <a data-js-permalink href="https://web.zorz.workers.dev" class="Button Button-is-bordered" type="button">Permalink</a>
          </div>
        </div>
      </div>
    ...
    <div class="Dialog---backdrop" dialog-backdrop>
      ...
      <div class="Dialog Dialog-is-medium" role="dialog" aria-modal="true" aria-labelledby="dialog-title" dialog>
        ...
        <div class="Dialog--content">
          ...
          <p>Built by <a class="Link" href="https://adamschwartz.co" target="_blank" rel="noopener">Adam Schwartz</a> using <a class="Link" href="https://workers.cloudflare.com" target="_blank" rel="noopener">Cloudflare Workers</a>, open-source and available on <a class="Link" href="https://github.com/adamschwartz/web.zorz.workers.dev" target="_blank" rel="noopener">GitHub</a>.</p>
        </div>
